	...
	<div class="container">
		...
		<ul class="nav pull-right">
			...
			<li><a href="/rebuild/user">Login</a></li>
			<!--<li class="dropdown">
	...
	<div class="carousel-inner">
		<div class="item active" id="slide-research-application">
			<div class="container">
				<img src="<?php print $directory; ?>/assets/img/banners/nesi-logo-big.png" />
		...
		<div class="item" id="slide-national-roadshow">
			...
			<div class="container">
				<img src="<?php print $directory; ?>/assets/img/banners/roadshow-map.png" />
				<div class="slide-content">
		...
		<div class="item" id="slide-case-study">
			<div class="container">
			<img src="<?php print $directory; ?>/assets/img/banners/case-study.jpg" />
				<div class="slide-content">
		...
		<section class="home-intro">
			...
			<div class="span4">
				<article class="sub-feature" id="facilities-intro">
					...
					<p>Learn all about the facilities that NeSI collaborates with. <a href="/?q=facilities" class="l-more">Learn more</a></p>
				</article>
			</div>
			<div class="span4">
