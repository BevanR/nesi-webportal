...
class Wkhtmltopdf
{
    ...
    protected function _getCommand()
    {
        ...
        $command .= ' --footer-font-size 7 --disable-javascript --ignore-load-errors --username webscope --password eden --dpi 96 '; // Katie hardcoding extra flags copied from printpdf config
